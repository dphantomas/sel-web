    ...
    <section className="bg-white">
      ...
      <div className="text-center mb-12">
        <a
          ...
          style={{
            ...
            fontFamily: "'Lato', sans-serif", fontSize: '14px', fontWeight: 600,
            textDecoration: 'none', boxShadow: '0 4px 14px rgba(255,0,0,0.25)',
          }}
        >
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 pb-16">
        ...
        {!loading && error && (
          <div className="text-center py-20">
            <p style={{ fontFamily: "'Open Sans', sans-serif", fontSize: '15px', color: '#999' }}>
              Could not load videos. Visit our{' '}
              <a href="https://www.youtube.com/@SanacionEnLuz" target="_blank" rel="noopener noreferrer"
                style={{ color: '#2ea3f2', textDecoration: 'underline' }}>YouTube channel</a> directly.
            </p>
          </div>
        )}
        {!loading && !error && (
          <>
            <div className="mb-16">
              <h2 className="mb-8 text-center" style={{
                ...
                color: '#33275f', fontWeight: 400, letterSpacing: '1px',
              }}>Videos</h2>
