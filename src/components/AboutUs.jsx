...
const founders = [
  {
    ...
    photoStyle: { objectPosition: '78% center' },
    summary: {
  ...
  },
  {
    ...
    photo: '/assets/darioymonica.jpg',
    photoClass: 'object-cover',
    photoStyle: { objectPosition: '25% center' },
    summary: {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {founders.map((founder) => (
            ...
            >
              ...
              >
                {typeof founder.role === 'object' ? founder.role[lang] : founder.role}
              </p>
              <p
                style={{
                  fontFamily: "'Open Sans', sans-serif",
              ...
              >
                {typeof founder.summary === 'object' ? founder.summary[lang] : founder.summary}
              </p>
              <button
        ...
        >
          ...
          >
            ...
            >
              <div>
                ...
                <span style={{ fontFamily: "'Lato', sans-serif", fontStyle: 'italic', fontSize: '13px', color: '#b085b3' }}>
                  {activeBio.role?.[lang] ?? activeBio.role}
                </span>
              </div>
              <button
                onClick={() => setActiveBio(null)}
            ...
            <div className="p-6 overflow-y-auto space-y-4 flex-grow">
              {(activeBio.fullBio?.[lang] ?? activeBio.fullBio ?? []).map((paragraph, i) => (
                <p
                  key={i}
                  style={{
                    fontFamily: "'Open Sans', sans-serif",
