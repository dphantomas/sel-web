...
export default function BlogGrid({ enPosts = null, limit = null }) {
  const postsToRender = enPosts || blogPosts;
        ...
        {displayedPosts.map((post) => (
          ...
          >
            ...
            <div className="relative overflow-hidden" style={{ height: '250px' }}>
              <img
                src={post.image || (post.title && post.title.rendered ? '' : undefined)} // fallback if WP post has no image mapped easily
