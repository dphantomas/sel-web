      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex justify-center items-center gap-4 mb-6">
          <a href="https://www.instagram.com/sanacion_en_luz" target="_blank" rel="noopener noreferrer"
            className="transition-transform hover:scale-110 flex items-center justify-center w-9 h-9 bg-white rounded-full shadow-sm" aria-label="Instagram">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-[22px] h-[22px]" fill="#33275f">
          ...
          <a href="https://www.facebook.com/sanacionenluz.2020" target="_blank" rel="noopener noreferrer"
            className="transition-transform hover:scale-110 flex items-center justify-center w-9 h-9 bg-white rounded-full shadow-sm" aria-label="Facebook">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-[22px] h-[22px]" fill="#33275f">
          ...
          <a href="https://api.whatsapp.com/send/?phone=5491141771120" target="_blank" rel="noopener noreferrer"
            className="transition-transform hover:scale-110 flex items-center justify-center w-9 h-9 bg-white rounded-full shadow-sm" aria-label="WhatsApp">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-[22px] h-[22px]" fill="#33275f">
          ...
          <a href="mailto:contacto@sanacionenluz.com"
            className="transition-transform hover:scale-110 flex items-center justify-center w-9 h-9 bg-white rounded-full shadow-sm" aria-label="Email">
