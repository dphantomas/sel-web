  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative min-h-[75vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        >
          <Image 
            src={cloudinaryUrl ? `${cloudinaryUrl}/el-hoyo-2.jpg` : (process.env.NEXT_PUBLIC_CLOUDINARY_ROOT_URL ? `${process.env.NEXT_PUBLIC_CLOUDINARY_ROOT_URL}/el-hoyo-2.jpg` : "/assets/el-hoyo-2.jpeg")}
